...
JNIEXPORT void JNICALL
Java_dev_gonative_%s_MainActivity_nativeDispatchSelectionEvent(JNIEnv *env, jobject renderer, jlong handler, jint start, jint end) {
    (void)env;
    (void)renderer;
...
`, jniPkg, jniPkg, jniPkg, jniPkg, jniPkg, jniPkg, jniPkg, jniPkg, jniPkg, jniPkg, jniPkg),
